...
describe('Редьюсер users', () => {
  ...
  describe('fetchUserRequest', () => {
    const fetchUserRequestState = users(initialState, fetchUserRequest());
  ...
  describe('fetchUserSuccess', () => {
    const state2 = users(initialState, fetchUserSuccess(testData));
  ...
  describe('fetchUserFailure', () => {
    const state3 = users(initialState, fetchUserFailure(error));
